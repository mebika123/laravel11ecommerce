    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between">
        ...
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-black-50" aria-current="page">Edit Products</li>
            </ol>
        </nav>
    </div>
                ...
                <div class="wg-box">
                    ...
                    <div class="group-input">
                        ...
                        <input type="text" class="input-field w-100" placeholder="Enter product slug" name="slug"
                            id="productSlug" value="{{ $product->name }}">
                        <p class="f-12 mt-1 text-black-50">Do not exceed 100 characters when entering
                            the
                            product</p>
                        @error('slug')
                    ...
                    <div class="group-input">
                        ...
                        <div class="d-flex align-items-center flex-wrap gap-4">
                            ...
                            <div class="item" id="imgpreview">
                                <img src="{{ asset('uploads/products/thumbnails') }}/{{ $product->image }}" alt="" class="effect8">
                            </div>
                            @endif
                        </div>
